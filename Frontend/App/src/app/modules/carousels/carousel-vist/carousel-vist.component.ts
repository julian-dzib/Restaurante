...
@Component({
  selector: 'app-carousel-vist',
  templateUrl: './carousel-vist.component.html',
  styleUrls: ['./carousel-vist.component.scss']
})
export class CarouselVistComponent implements OnInit {
